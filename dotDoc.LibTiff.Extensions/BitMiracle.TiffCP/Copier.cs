...
{
    // MK 22/04/21 Supress any warnings raised by this code.
    [SuppressMessage("Style", "IDE1006:Naming Styles", Justification = "Third party code.")]
    [SuppressMessage("Style", "IDE0044:Add readonly modifier", Justification = "Third party code.")]
    [SuppressMessage("Style", "IDE0057:Use range operator", Justification = "Third party code.")]
    [SuppressMessage("Style", "IDE0059:Unnecessary assignment of a value", Justification = "Third party code.")]
    [SuppressMessage("Style", "IDE0060:Remove unused parameter", Justification = "Third party code.")]
    public class Copier
    {
        struct tagToCopy
        {
        ...
        // 9/8/2019 MK made m_quality public so I can set it from TiffUtilities
        public int m_quality = 75; /* JPEG quality */
